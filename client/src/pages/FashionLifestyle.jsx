...
import { FaTshirt, FaCalendarAlt, FaClock, FaSort } from 'react-icons/fa';
import Navbar from '../components/Navbar';

const ACCENT = '#f472b6';
const GRADIENT = 'linear-gradient(135deg, #f8fafc 0%, #fce7f3 50%, #fbcfe8 100%)';
...
const FALLBACK_IMG = 'https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=facearea&w=400&h=200';
const CONTAINER_SHADOW = '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)';

const initialEvents = [
  {
    img: 'https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=facearea&w=400&h=200',
    name: 'Fashion Week',
    date: '2024-11-05',
    time: '18:00',
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          right: 0,
          bottom: 0,
          background: 'radial-gradient(circle at 50% 0%, rgba(244,114,182,0.08) 0%, transparent 50%)',
          pointerEvents: 'none',
          zIndex: 0,
        }} />
        <div style={{
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <label style={{ fontWeight: 500, color: '#db2777' }}>Date:</label>
              <input 
                type="date" 
                value={filterDate} 
            ...
            <div style={{ 
              ...
              <label style={{ fontWeight: 500, color: '#db2777' }}>Time:</label>
              <input 
                type="time" 
                value={filterTime} 
            ...
            <div style={{ 
              ...
              <label style={{ fontWeight: 500, color: '#db2777' }}>Sort by:</label>
              <select 
                value={sortBy} 
