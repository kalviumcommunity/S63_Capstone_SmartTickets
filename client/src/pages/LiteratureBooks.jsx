...
import { FaBook, FaCalendarAlt, FaClock, FaSort } from 'react-icons/fa';
import Navbar from '../components/Navbar';

const ACCENT = '#a78bfa';
const GRADIENT = 'linear-gradient(135deg, #f8fafc 0%, #ede9fe 50%, #c7d2fe 100%)';
...
const FALLBACK_IMG = 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=facearea&w=400&h=200';
const CONTAINER_SHADOW = '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)';

const initialEvents = [
  {
    img: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=facearea&w=400&h=200',
    name: 'Book Fair',
    date: '2024-10-05',
    time: '10:00',
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          right: 0,
          bottom: 0,
          background: 'radial-gradient(circle at 50% 0%, rgba(168,139,250,0.08) 0%, transparent 50%)',
          pointerEvents: 'none',
          zIndex: 0,
        }} />
        <div style={{
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <label style={{ fontWeight: 500, color: '#7c3aed' }}>Date:</label>
              <input 
                type="date" 
                value={filterDate} 
            ...
            <div style={{ 
              ...
              <label style={{ fontWeight: 500, color: '#7c3aed' }}>Time:</label>
              <input 
                type="time" 
                value={filterTime} 
            ...
            <div style={{ 
              ...
              <label style={{ fontWeight: 500, color: '#7c3aed' }}>Sort by:</label>
              <select 
                value={sortBy} 
